		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-sm-12">
					...
					<center>
					<h2 class="title text-center">Thank you for shopping with XXXX.com</h2>
						<h4 style="color:#2b338e;">Soon our customer care will contact you for final confirmation of order.</h4>
						<h4 style="color:#2b338e;">You have to do cash on delivery (COD) for ordered products.</h4>
						<h5 style="color:#2b338e;"> You will receive your order within 4-5 working days. You can track your order from your account on XXXX.com</h5>
						<h5 style="color:#cb3327;"> Details of order have send on your registered e-mail address.</h5>
