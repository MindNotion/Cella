			...
			<div class="table-responsive cart_info">
				<table class="table table-condensed">
					...
					<?php
							...
							<td class="cart_price">
								<a   href="checkout.php"  class="btn btn-success"><i class="fa fa-rupees"></i> Checkout</a>
							</td>
							...
							<td class="cart_delete">
								...
								echo '<script type="text/javascript">$(document).ready(function(e) {$("#checkout").hide(); });</script>';
								}
						?>
