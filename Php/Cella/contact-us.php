    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">    			   			
					...
					<h4>*Replace below Google Map by your Map</h4>
					<script type="text/javascript" src="http://maps.google.com/maps/api/js?sensor=false"></script><div style="overflow:hidden;height:385px;width:1140px;"><div id="gmap_canvas" style="height:385px;width:1140px;"></div><style>#gmap_canvas img{max-width:none!important;background:none!important}</style><a class="google-map-code" href="http://www.pureblack.de/gutscheine/pixum" id="get-map-data">http://www.pureblack.de/gutscheine/pixum</a></div><script type="text/javascript"> function init_map(){var myOptions = {zoom:14,center:new google.maps.LatLng(19.2127565,72.82274489999999),mapTypeId: google.maps.MapTypeId.ROADMAP};map = new google.maps.Map(document.getElementById("gmap_canvas"), myOptions);marker = new google.maps.Marker({map: map,position: new google.maps.LatLng(19.2127565, 72.82274489999999)});infowindow = new google.maps.InfoWindow({content:"<b>MindNotion Software Consultancy</b><br/>Charkop, Kandivali(W)<br/> mumbai" });google.maps.event.addListener(marker, "click", function(){infowindow.open(map,marker);});infowindow.open(map,marker);}google.maps.event.addDomListener(window, 'load', init_map);</script>
					</div>
				</div>			 		
			</div>    	
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
				    	...
				    	<form id="main-contact-form" class="contact-form row" name="contact-form" method="post" action="php/send_enquiry.php">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
							...
							<p>Company Address</p>
							<p>State, Country</p>
							<p>Mobile: Company Mobile Number</p>
							<p>Fax: Company Fax Number</p>
							<p>Email: Company E-Mail ID</p>
	    				</address>
