					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="col-sm-6">
									<h1><span>Mind</span>Notion</h1>
									<h2>CELLA Free E-Commerce Solution</h2>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
							...
							<div class="product-image-wrapper">
								<div class="single-products">
										<div class="productinfo text-center">
											...
											<p>That compliments your style</p>
											<a href="frontend/productlist.php?gender=female&category=Jewellery" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View</a>
										</div>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>Kurtis</h2>
										<p>Highly comfortable and unique</p>
										<a href="frontend/productlist.php?gender=female&category=Kurtis" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<h2>Kurtis</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<p>Get great deal</p>
										<a href="frontend/productlist.php?gender=all&category=electronics" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<h2>Home Appliances</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>New Arrival</h2>
										<p>Fresh fashion for you</p>
										<a href="frontend/productlist.php?gender=female&new_arrival=1" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<h2>New Arrival</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>Sale & Discount</h2>
										<p>Genuine products at discounted price</p>
										<a href="frontend/productlist.php?gender=female&discount_percent=true" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<h2>Sale & Discount</h2>
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										...
										<h2>Sarees</h2>
										<p>Presenting artistic excellence</p>
										<a href="frontend/productlist.php?gender=female&category=Saree" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>View</a>
									</div>
									<div class="product-overlay">
										<div class="overlay-content">
											<h2>Sarees</h2>
					...
					<div class="category-tab"><!--category-tab-->
						<div class="col-sm-12">
							<ul class="nav nav-tabs" id="SubCategories">
								
							</ul>
						</div>
						<div class="tab-content" id="productSubCategories">
